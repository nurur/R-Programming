...
#plt.scatter(df.score_x, df.score_y)
#plt.xlabel('ACSI data', fontsize=15)
#plt.ylabel('Twitter data', fontsize=15)
#plt.axis([-1,100,50,100])
#plt.show()
#Pandas plotting 
#df.plot(x='score_x', y='score_y', xlim=[0,100], ylim=[50,100])
#plt.show()
